...
class Pb210sTracer(GenericTracer):
    ...
    def __init__(self, tracerName, modelObject, keyFile, yAxisType, timeRecord, fileLevel):
        ...
        if "TR_GOCART" in modelObject.fileName or "cycling" in modelObject.fileName:
            print("Pb210s tracer needs specific humidity")
    ...
    def createDiffContoursFromMinMaxPb210s(self, minVal, maxVal):

        print("Pb210s createDiff received: ", minVal, maxVal)
        ...
        print("Pb210s createDiff mew min/max: ", minVal, maxVal, "...", newMin, newMax)
